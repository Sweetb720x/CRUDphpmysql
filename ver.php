                    ...
                    foreach($resultado as $resu){
                        ?>
                            <tr>
                                ...
                                <td><a href="http://localhost/Repaso-PHP/CRUD/eliminar.php?id=<?php echo $resu['id']?>" class="borrar"><i class="fa fa-trash"></i></a></td>
                                <td><a href="http://localhost/Repaso-PHP/CRUD/editar.php?id=<?php echo $resu['id']?>" class="editar"><i class="fa fa-wrench"></i></a></td>
                            </tr>                     
                        <?php
                    }
                ?> 
